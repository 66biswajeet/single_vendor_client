...
const Cart = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-white rounded-lg">
      <div className="w-full flex justify-between items-center px-6 py-4 border-b border-gray-300 ">
        <div className="flex items-center">
          <div className="bg-yellow-600 text-white p-2 rounded-full mr-3">
        ...
        {isEmpty ? (
          <div className="flex flex-col h-full justify-center items-center px-6 py-12">
            <div className="bg-yellow-100 p-6 rounded-full mb-6">
              <IoBagHandle className="w-16 h-16 text-yellow-500" />
            </div>
            ...
            <button
              ...
              className="mt-6 px-6 py-3 bg-yellow-600 hover:bg-gray-900 text-white rounded-lg font-medium transition-colors"
            >
              Continue Shopping
            </button>
          </div>
      ...
      {!isEmpty && items && items.length > 0 && (
        <div className="border-t border-gray-300-light">
          <div className="px-6 py-4">
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-transparent border-2 border-yellow-600 text-yellow-600 hover:bg-yellow-600 hover:text-white rounded-lg font-semibold flex items-center justify-between transition-all duration-300 group"
            >
              <span>Proceed To Checkout</span>
              <span className="bg-yellow-600 text-white group-hover:bg-white group-hover:text-yellow-700 px-3 py-1 rounded-full text-sm font-bold transition-all duration-300">
                {currency}
                {displayTotal}
              </span>
            </button>
